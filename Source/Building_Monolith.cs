    ...
    public class Building_Monolith : Building
    {
        ...
        public Thought_Memory GiveObservedThought()
        {
            if (this.StoringBuilding() == null)
            {
                ...
                thought_MemoryObservation = (Thought_MemoryObservation)ThoughtMaker.MakeThought(DefDatabase<ThoughtDef>.GetNamed("ObservedNightmareMonolith"));
                ...
                else
                {
                    if (Dave.needs.TryGetNeed<Need_CultMindedness>().CurLevel > 0.7)
                        thought_MemoryObservation = (Thought_MemoryObservation)ThoughtMaker.MakeThought(DefDatabase<ThoughtDef>.GetNamed("ObservedNightmareMonolithCultist"));
                }
