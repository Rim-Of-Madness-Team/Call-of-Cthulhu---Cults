...
namespace CultOfCthulhu
{
    public class SpellWorker_ForbiddenKnowledge : SpellWorker
    {
        ...
        protected Building_ResearchBench ResearchStation(Map map)
        {
            ...
            if (benches.TryRandomElement(result: out var bench))
            {
                return bench;
            }
        ...
        {
            var flag = ResearchStation(map: map) != null && ResearchProject() != null;

            if (ResearchStation(map: map) == null)
            {
            ...
            {
                Messages.Message(text: "There are no research benches to be found.", def: MessageTypeDefOf.RejectInput);
            ...
            {
                Messages.Message(text: "There are no research projects currently being researched.",
        ...
        protected override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            _ = Find.ResearchManager.GetProgress(proj: ResearchProject());
            ...
            Find.ResearchManager.ResearchPerformed(amount: researchAddedProgress, researcher: executioner(map: map));


            map.GetComponent<MapComponent_SacrificeTracker>().lastLocation = executioner(map: map).Position;
            Messages.Message(text: "Nyarlathotep grants your colony forbidden knowledge.", def: MessageTypeDefOf.PositiveEvent);
